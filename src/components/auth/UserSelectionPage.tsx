...
import PhotographerWaitlistModal from './PhotographerWaitlistModal';
...
const UserSelectionPage: React.FC<UserSelectionPageProps> = ({ onClose }) => {
          ...
          <div className="flex-1 flex flex-col items-center justify-center px-6">
            ...
            <div className="w-full max-w-md space-y-6">
              ...
              <button
                ...
                className="w-full bg-white rounded-xl border border-gray-200 p-8 text-center hover:border-gray-300 hover:shadow-sm transition-all duration-200 group"
              >
                ...
                <p className="text-gray-600 text-sm">
                  Looking for amazing surf photography<br />
                  and videos
                </p>
              </button>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Ready to showcase and sell my surf content
                </p>
              </button>
            </div>
            ...
            <div className="mt-12 text-center">
              ...
              <button
                ...
                className="text-gray-900 font-medium hover:text-primary transition-colors underline"
              >
                Sign in
              </button>
            </div>
